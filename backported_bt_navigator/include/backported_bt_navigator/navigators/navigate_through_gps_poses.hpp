...
#ifndef BACKPORTED_BT_NAVIGATOR__NAVIGATORS__NAVIGATE_THROUGH_GPS_POSES_HPP_
#define BACKPORTED_BT_NAVIGATOR__NAVIGATORS__NAVIGATE_THROUGH_GPS_POSES_HPP_
...
#include "nav2_util/service_client_ex.hpp"
 ...
 */
class NavigateThroughGPSPosesNavigator
  : public backported_bt_navigator::BehaviorTreeNavigator<nav2_msgs::action::NavigateThroughGPSPoses>
{
public:
...
protected:
  ...
  /**
   * @brief Converts GPS poses to map frame poses using robot_localization's FromLL service
   * @param gps_poses Vector of GeoPose messages
   * @return Vector of PoseStamped messages in map frame
   */
  ...
  // Service client for converting GPS to map frame
  std::unique_ptr<nav2_util::ServiceClientEx<robot_localization::srv::FromLL, 
    std::shared_ptr<rclcpp_lifecycle::LifecycleNode>>> from_ll_to_map_client_;
};

}  // namespace backported_bt_navigator

#endif  // BACKPORTED_BT_NAVIGATOR__NAVIGATORS__NAVIGATE_THROUGH_GPS_POSES_HPP_
